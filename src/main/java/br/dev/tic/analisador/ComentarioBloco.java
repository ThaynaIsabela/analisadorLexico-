...
public class ComentarioBloco implements Estagio {
    ...
    ComentarioBloco(String namespace) {
    ...
    private String getNomeProximoSimbolo() {
        ...
        return "ComentarioBloco" + (this.namespace != null ? "-" + this.namespace : "")
                + String.format("%d", this.numeroComentario);
    }

    public String getNomeEstagio() {
        return "ComentarioBloco";
    }
